<template>
  <div class="wrapBox">
      ...
      <div class="wrapBox4">
        ...
        <div class=" wrapBox5">
          ...
          <div class="input-group">
            ...
            <textarea class="form-control contentBox" aria-label="With textarea" v-model="aQnADetail.qa_content"></textarea>
          </div>
    ...
    <div class="btnBox">
      <button type="button" class="btn btn-primary" @click.prevent="aqnaRegist">등록하기</button>
...
export default {components: {SoftInput, SoftButton},
  ...
  methods: {
    ...
    aqnaRegist() {
      let myData = {
        user_id: this.aQnADetail.user_id,
        com_num: JSON.parse(sessionStorage.getItem('sessionComp')),
        qa_content: this.aQnADetail.qa_content,
